...
app.use((req, res, next) => {
  ...
  //// TODO: TIME
  // console.log(app.locals.timePassed);
  if (app.locals.timeOut == false){
    app.locals.timePassed = new Date() - app.locals.timeStart;
  }
  if (app.locals.timePassed > (1000*10) && app.locals.timeOut == false){
    // console.log("shum");
    app.locals.timeOut = true;
  }
